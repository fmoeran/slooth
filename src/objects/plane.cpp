...
namespace slt
{
    ...
    void Plane::initVertices() {
        ...
        _vertices = std::make_unique<Vertex[]>(_numVerts);
        ...
        for (size_t index=0; index<_numVerts; index++) {
            ...
            _vertices[index] = Vertex(bottomLeft + vec3(xOffset, 0, zOffset));
        }
        ...
        Object::setVertices(VertexEnum::VERTEX,
                            _vertices.get(), sizeof(Vertex) * _numVerts,
